...
Route::middleware(['auth', 'check.active', 'role:head_of_finance'])
    ...
    ->group(function () {
        ...
        Route::prefix('settings')->name('settings.')->group(function () {
            ...
            Route::patch('expense-patterns/{expensePattern}/fields/{fieldKey}', [\App\Http\Controllers\FinanceHead\Settings\ExpensePatternController::class, 'updateField'])->name('expense-patterns.fields.update');
            Route::delete('expense-patterns/{expensePattern}/fields/{fieldKey}', [\App\Http\Controllers\FinanceHead\Settings\ExpensePatternController::class, 'destroyField'])->name('expense-patterns.fields.destroy');
            Route::get('expense-setup', [\App\Http\Controllers\FinanceHead\Settings\ExpenseStructureController::class, 'overview'])->name('expense-setup.index');
            ...
            Route::patch('expense-default-rows/{expenseCatalogItem}', [\App\Http\Controllers\FinanceHead\Settings\ExpenseDefaultRowAccountController::class, 'update'])->name('expense-default-rows.update');
            Route::delete('expense-default-rows/{expenseCatalogItem}', [\App\Http\Controllers\FinanceHead\Settings\ExpenseDefaultRowAccountController::class, 'destroy'])->name('expense-default-rows.destroy');
            Route::patch('expense-default-rows/{expenseCatalogItem}/account', [\App\Http\Controllers\FinanceHead\Settings\ExpenseDefaultRowAccountController::class, 'update'])->name('expense-default-rows.account.update');
