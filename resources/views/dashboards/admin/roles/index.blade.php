...
<div class="admin-resource" x-data="{ createModal: @js((bool) old('admin_create_modal')), editModal: @js(old('admin_edit_modal')), viewModal: null }" @open-create-modal.window="createModal = true">
    ...
    <section class="admin-filter-panel">
        <form method="GET" action="{{ route('admin.roles.index') }}" class="admin-filter-form admin-filter-form-simple admin-filter-form-auto" x-data="{ filterTimer: null, submitFilter() { clearTimeout(this.filterTimer); this.filterTimer = setTimeout(() => this.$el.requestSubmit(), 450); } }" @input="submitFilter()">
